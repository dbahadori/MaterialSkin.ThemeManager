...
for Invalidate()*/
        ...
        protected override void OnCreateControl()
        {
            ...
            WaterMark_Toggel(null, null, "Lost");
        }
        ...
        private void JoinEvents(Boolean join)
        {
            ...
            if (join)
            {
                ...
                this.TextChanged += new System.EventHandler((sender, e) => this.WaterMark_Toggel(sender, e, "Got"));
                this.LostFocus += new System.EventHandler((sender, e) => this.WaterMark_Toggel(sender, e, "Lost"));
                this.FontChanged += new System.EventHandler(this.WaterMark_FontChanged);

                this.GotFocus += new System.EventHandler((sender,e)=>this.WaterMark_Toggel(sender,e, "Got"));
        ...
        private void WaterMark_Toggel(object sender, EventArgs args, string focusstate )
        {

            if ((this.Text.Length <= 0) && (focusstate=="Lost"))
                EnableWaterMark();
